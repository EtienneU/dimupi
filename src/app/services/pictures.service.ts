...
import picturesJsonData from '../../assets/pictures-items.json';

@Injectable({
  providedIn: 'root'
})
export class PicturesService {
  // ------------ Récupération des Pictures du JSON File ------------
  pictures: Picture[] = picturesJsonData

  // ----------------- Ancienne base locale en dur ------------------
  // pictures: Picture[] = [
  //   {
  //     id: 1,
  //     title: "leaves",
